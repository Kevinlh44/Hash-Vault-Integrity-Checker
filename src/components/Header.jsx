  ...
  <header className="flex justify-between items-center py-6 border-b border-border-subtle mb-8">
    <div className="flex items-center gap-4">
      ...
      <div className="relative w-14 h-14 flex items-center justify-center">
        <div className="absolute inset-0 bg-color-brand-cyan/20 animate-pulse rounded-xl rotate-45">
      ...
      <div>
        <h1 className="text-3xl font-extrabold tracking-[0.1em] text-color-brand-cyan drop-shadow-[0_0_8px_rgba(0,240,255,0.5)]" style={{ fontFamily: "'Orbitron', sans-serif" }}>
          HASHVAULT
        </h1>
